# -*- coding: utf-8 -*-
"""
Created on Sun May  1 18:51:38 2022

@author: Antonella Zambrano
"""
...
espacio = tk.Label(ventana, bg="navajowhite2", fg="LightSalmon")
espacio.grid (row = 0, column = 0)

texto1 = tk.Label(ventana, text="Distancia Focal (mm)=", bg="LightSalmon", fg="gray20")
texto1.grid (row = 1, column = 0)

cuadro1 = tk.Entry(ventana, font = "Helvetica ", justify = "left")
cuadro1.grid (row = 1, column = 1)

texto2 = tk.Label(ventana, text="Ancho del sensor (mm) =", bg="LightSalmon", fg="gray20")
texto2.grid (row = 1, column = 2)

cuadro2 = tk.Entry(ventana, font = "Helvetica 12", justify = "left")
cuadro2.grid (row = 1, column = 3)

texto3 = tk.Label(ventana, text="Solape Longitudinal (%)=", bg="LightSalmon", fg="gray20")
texto3.grid (row = 1, column = 4)

cuadro3 = tk.Entry(ventana, font = "Helvetica ", justify = "left")
cuadro3.grid (row = 1, column = 5)

#SEGUNDA FILA

espacio1 = tk.Label(ventana, bg="LightSalmon", fg="LightSalmon")
espacio1.grid (row = 2, column = 0)

texto4 = tk.Label(ventana, text="Ancho de la imagen (Pixel)=", bg="LightSalmon", fg="gray20")
texto4.grid (row = 3, column = 0)

cuadro4 = tk.Entry(ventana, font = "Helvetica 12", justify = "left")
cuadro4.grid (row = 3, column = 1)

texto5 = tk.Label(ventana, text="Alto del sensor (mm)=", bg="LightSalmon", fg="gray20")
texto5.grid (row = 3, column = 2)

cuadro5 = tk.Entry(ventana, font = "Helvetica  12", justify = "left")
cuadro5.grid (row = 3, column = 3)

texto6 = tk.Label(ventana, text="Solape Transversal (%)=", bg="LightSalmon", fg="gray20")
...
espacio2 = tk.Label(ventana, bg="LightSalmon", fg="gray20")
...
texto8 = tk.Label(ventana, text="Altura del vuelo (m)=", bg="LightSalmon", fg="gray20")
texto8.grid (row = 5, column = 2)

cuadro8 = tk.Entry(ventana, font = "Helvetica 12", justify = "left")
cuadro8.grid (row = 5, column = 3)

texto9 = tk.Label(ventana, text="Largo de la parcela (m)=", bg="LightSalmon", fg="gray20")
...
espacio3 = tk.Label(ventana, bg="LightSalmon", fg="gray20")
espacio3.grid (row = 6, column = 0)

texto10 = tk.Label(ventana, text="Ancho de la parcela (m)=", bg="LightSalmon", fg="gray20")
texto10.grid (row = 7, column = 0)

cuadro10 = tk.Entry(ventana, font = "Helvetica 12", justify = "left")
cuadro10.grid (row = 7, column = 1)

texto11 = tk.Label(ventana, text="Velocidad del vuelo (m/s)=", bg="LightSalmon", fg="gray20")
texto11.grid (row = 7, column = 2)

cuadro11 = tk.Entry(ventana, font = "Helvetica 12", justify = "left")
cuadro11.grid (row = 7, column = 3)

espacio3 = tk.Label(ventana, bg="LightSalmon", fg="LightSalmon")
espacio3.grid (row = 8, column = 0)


espacio3 = tk.Label(ventana, bg="LightSalmon", fg="coral")
...
def resultados():
    ...
    distancia_focal = float(cuadro1.get())
    ...
    altura_de_vuelo = float(cuadro8.get())
    ...
    #GSD
    GSD = (((altura_de_vuelo * 100 )/ (distancia_focal)) * RSI)
    textoResult.insert(tk.END, f"GSD = {GSD}cm/pixel\n\n")
    
    #Escala de Vuelo
    escala_vuelo = 1/((distancia_focal/1000)/altura_de_vuelo)
...
boton_calculo = tk.Button(text = "Calcular", font= 'Helvetica 11', command = resultados)
